...
var List = /** @class */ (function () {
     ...
     * @returns {this} The List instance.
     */
    List.prototype.addToStart = function (value) {
     ...
     * @returns {this} The List instance.
     */
    List.prototype.applyAll = function (callback) {
     ...
     */
    List.prototype.concatAll = function (separator) {
     ...
     */
    List.prototype.contains = function (value, startIndex) {
     ...
     * @returns {this} The List instance.
     */
    List.prototype.each = function (callback, exitCondition) {
     ...
     * @returns {T} TODO
     */
    List.prototype.getValueByIndex = function (index) {
     ...
     */
    List.prototype.indexOf = function (value, fromIndex) {
     ...
     * @returns {number} Index of matched value or if nothing matchs null.
     */
    List.prototype.lastIndexOf = function (value, fromIndex) {
     ...
     * @returns {this} The List instance.
     */
    List.prototype.removeByIndex = function (indices) {
